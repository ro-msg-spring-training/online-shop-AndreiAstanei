...
insert into hibernate_sequence values ( 1 );
insert into hibernate_sequence values ( 1 );
create table location (id integer not null, address_city varchar(255), address_country varchar(255), address_county varchar(255), address_street_address varchar(255), name varchar(255), primary key (id)) engine=InnoDB;
create table order_ (id integer not null, address_city varchar(255), address_country varchar(255), address_county varchar(255), address_street_address varchar(255), created_at datetime, customer_id integer, shipped_from_id integer, primary key (id)) engine=InnoDB;
...
create table product (id integer not null, description varchar(255), image_url varchar(255), name varchar(255), price decimal(19,2), weight double precision, category_id integer, supplier_id integer, primary key (id)) engine=InnoDB;
